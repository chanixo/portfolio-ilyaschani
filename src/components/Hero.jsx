...
import profilePic from "../assets/ilyasss.jpg";
  ...
  return <div className="border-b border-neutral-900 pb-4 lg:mb-35">
    <div className="flex flex-wrap">
        ...
        <div className="flex flex-col items-center lg:items-start">
            ...
            initial="hidden"
            animate="visible"
            className="pb-16 text-6xl font-thin tracking-tight lg:mt-16 lg:text-8xl">Ilyas Chani </motion.h1>
            <motion.span 
            variants={container(0)}
            initial="hidden"
            animate="visible"
        ...
        <div className="w-full lg:w-1/2 lg:p-8">
          <div className="flex justify-center">
            ...
            transition={{duration:1,delay:1.2}}
              src={profilePic}
              alt="ilyas chani"
              className="w-85 h-85 lg:w-90 lg:h-90 rounded-lg transform -translate-y-6"            />
        </div>
        </div>
    </div>
  </div>
